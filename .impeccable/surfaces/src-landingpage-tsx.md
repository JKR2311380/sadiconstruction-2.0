...
Chosen: Site Mark enrichment — steel & concrete material palette; Kenney Mini Characters CC0 Roles figure (Quaternius Worker was API-gated); capability micros per role. Formwork remains unmounted.

## Direction contract

THESIS: A building rises in four discrete phases while the page teaches CPM as motion — forward pass, backward pass, float, spine. Refuses hero-header-footer SaaS and the incumbent charcoal-orange directory.

OWN-WORLD: Steel & concrete site materials — `#EEF1F0` ground, `#D6DAD6` / `#BCC3BF` concrete, `#3E5A6C` / `#CAD6DD` steel, `#15253A` navy Engine band, ink `#0E1210`, survey-mark lime `#D4FF4A` critical-only, safety amber `#E2A33B` for hard hat / slip callouts only. Syne · Manrope · IBM Plex Mono. Grain overlay on hero and Roles. 2px controls, 2px radius.
...
FINISH: bounded screenshot pass at 1440 and 375, reduced-motion pass, DESIGN.md landing section.
